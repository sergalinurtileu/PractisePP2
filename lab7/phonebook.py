...
def menu():
    while True:
        ...
        elif choice == "4": find_by_name()
        elif choice == "5": find_by_prefix()
        elif choice == "6": change_name()
        elif choice == "7": change_phone()
        elif choice == "8": remove_by_name()
        elif choice == "9": remove_by_phone()
        elif choice == "0":
            print("Exiting...")
            break
        else:
